...
public class ModRecipes {
    ...
    public static final List<FluidExtractionRecipe> RECIPES = new ArrayList<>();
    ...
    public static final RegistryObject<RecipeType<FluidExtractionRecipe>> FLUID_EXTRACTION_RECIPE_TYPE
            = TYPE_REGISTER.register("fluid_extraction", () -> FLUID_EXTRACTION_TYPE);
}
